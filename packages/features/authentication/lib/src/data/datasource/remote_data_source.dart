...
/// implementation of the [AuthenticationClient] that uses Firebase Authentication.
class AuthenticationClientImpl implements AuthenticationClient {
  ...
  Future<void> signUpWithPassword({
    ...
    try {
      ...
      //   password: password,
      // );
      // await user.updateProfile(displayName: fullName, photoURL: avatarUrl);
      // await user.sendEmailVerification();
    } on SignUpWithPasswordFailure catch (e) {
      rethrow;
